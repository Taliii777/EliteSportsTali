    ...
    <>
      <div className='flex max-h-screen items-center justify-center font-sans relative h-screen w-full overflow-hidden'>
        ...
        <div className='absolute top-0 left-0 right-0 bottom-0 z-10 bg-black/30'>
          <div className='flex flex-col items-center justify-center h-full w-full px-4 max-w-full overflow-hidden'>
            <h1 className='text-light font-inter text-2xl sm:text-3xl md:text-6xl lg:text-8xl font-extrabold uppercase max-w-full wrap-break-word text-left leading-none'>
              OUR SERVICES
            </h1>
      ...
      <div className='px-5 md:px-15 py-20'>
        <div className='flex justify-center gap-5 mb-20 max-w-5xl mx-auto'>
          <h1 className='text-darkBlue text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold font-inter uppercase text-center'>
            ELEVATE YOUR CAREER BEYOND THE COURT.
          </h1>
        </div>
        <div className='flex justify-end gap-5'>
          <p className='text-darkBlue text-lg font-condensed font-medium text-center uppercase max-w-3xl mx-auto tracking-widest'>
              ...
              >
                ...
                <div className='flex flex-col items-center justify-between h-full w-full mx-auto gap-10'>
                  <div className='flex flex-col items-center justify-center w-full'>
                    ...
                    <p className='text-light text-sm md:text-lg font-condensed font-normal text-center leading-relaxed uppercase'>
      ...
      <div className='px-10 py-20 flex flex-col items-center justify-center gap-10'>
        <p className='text-darkBlue text-lg font-condensed font-medium text-center uppercase tracking-widest'>
